...
public class CurrentStatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doitButton.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(CurrentStatusActivity.this, ProgressActivity.class);
            intent.putExtra("dailyPlan", dailyPlan);
            startActivity(intent);


            Intent dataIntent = new Intent(CurrentStatusActivity.this, dataActivity.class);
            dataIntent.putExtra("dailyPlan", dailyPlan);
